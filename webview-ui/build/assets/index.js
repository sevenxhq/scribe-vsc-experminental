...
`;class Ea extends Q{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Da=Ea.compose({baseName:"text-field",template:Xo,styles:Aa,shadowOptions:{delegatesFocus:!0}}),{wrap:D}=tr(Ns,ir());D(Or(),{name:"vscode-badge"});const qa=D(Fr(),{name:"vscode-button"});D(Vr(),{name:"vscode-checkbox",events:{onChange:"change"}});D(jr(),{name:"vscode-data-grid"});D(Wr(),{name:"vscode-data-grid-cell"});D(qr(),{name:"vscode-data-grid-row"});D(Yr(),{name:"vscode-divider"});D(Kr(),{name:"vscode-dropdown",events:{onChange:"change"}});D(ia(),{name:"vscode-link"});D(oa(),{name:"vscode-option"});D(da(),{name:"vscode-panels",events:{onChange:"change"}});D(ua(),{name:"vscode-panel-tab"});D(fa(),{name:"vscode-panel-view"});D(ma(),{name:"vscode-progress-ring"});D(Ca(),{name:"vscode-radio",events:{onChange:"change"}});D(xa(),{name:"vscode-radio-group",events:{onChange:"change"}});D(Ia(),{name:"vscode-tag"});const Ga=D(Ra(),{name:"vscode-text-area",events:{onChange:"change",onInput:"input"}}),Wa=D(Da(),{name:"vscode-text-field",events:{onChange:"change",onInput:"input"}});export{Wa as V,Ga as a,qa as b};
